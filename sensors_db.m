...
%  see also: VIBANALYZER, VIBPLOTS, VIBLOGGER
    ...
    sensors('30444_X') = struct(  'sens', 10e-6,...
                                'make', 'Bruel and Kjaer',...
                                'model', '4326A');
    sensors('30444_Y') = struct(  'sens', 10e-6,...
                                'make', 'Bruel and Kjaer',...
                                'model', '4326A');
    sensors('30444_Z') = struct(  'sens', 10e-6,...
                                'make', 'Bruel and Kjaer',...
                                'model', '4326A');                            

    sensors('I20_MONO_Y') = struct(  'sens', 1e-9,...
                                'make', 'Bruel and Kjaer',...
                                'model', '4326A'); 
    sensors('I20_MONO_Z') = struct(  'sens', 1e-9,...
                                'make', 'Bruel and Kjaer',...
                                'model', '4326A');                             
    % --- end sensors DB ---
