...
%  see also: VIBANALYZER, VIBPLOTS, VIBLOGGER
    ...
    sensors('61715') = struct(  'sens', 1.002e-9,...
                                'make', 'PCB',...
                                'model', '393B31');
    ...
    sensors('CMG-T3E-0038_Vertical') = struct(  'sens', 3.1e-6,...
                                'make', 'Guralp',...
                                'model', 'CMG-ESPD');
    sensors('CMG-T3E-0038_North') = struct(  'sens', 3.2e-6,...
                                'make', 'Guralp',...
                                'model', 'CMG-ESPD');
    sensors('CMG-T3E-0038_East') = struct(  'sens', 3.2e-6,...
                                'make', 'Guralp',...
                                'model', 'CMG-ESPD');
